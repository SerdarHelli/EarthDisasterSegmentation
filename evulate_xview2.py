...
#ref https://github.com/DIUx-xView/xView2_scoring/blob/master/xview2_metrics.py
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_dir", type=str, required=True,help="pred_dir (str): directory of localization and damage predictions Path")
    parser.add_argument("--targ_dir", type=str, required=True,help="targ_dir (str): directory of localization and damage targets")
    parser.add_argument("--out_fp", type=str, required=True,help="out_fp   (str): output json - folder must already exist")
    args = parser.parse_args()
    fire.Fire(XviewMetrics.compute_score(args.pred_dir,args.targ_dir,args.out_fp))